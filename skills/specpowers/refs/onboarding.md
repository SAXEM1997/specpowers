...
2. **每个 Phase 遇到问题时**，参考对应框架文档：OpenSpec 查 `/opsx:explore` 帮助，Superpowers 查技能目录中的 skill 列表（Claude Code：`/skills`）
...
（Superpowers 含 brainstorming/writing-plans/test-driven-development 等 skill，完整列表见技能目录；Claude Code 为 `/skills` 命令）
